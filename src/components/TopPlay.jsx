...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePauseClick,
  ...
  py-2 p-2 sm:p-4 rounded-lg cursor-pointer mb-2">
    <h3 className="font-bold text-base text-white mr-2 sm:mr-3">
      {i + 1}.</h3>
    <div className="flex-1 flex flex-row justify-between items-center min-w-0">
      <img className="w-14 h-14 sm:w-20 sm:h-20 rounded-lg object-cover" src={song?.images?.coverart}
        alt={song.title} />
...
const TopPlay = () => {
  ...
  return (
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 pt-6
    flex-1 xl:max-w-[380px] max-w-full flex flex-col">
